...
{{--                    <img src="{{asset('assets/images/slider/slider-bg-1.jpg')}}" alt="" class="img-slide">--}}
{{--                    <div class="slide-info slide-1">--}}
{{--                        <h2 class="f-title">All <b>Medications</b></h2>--}}
...
{{--                </div>--}}
{{--                <div class="item-slide">--}}
{{--                    <img src="{{asset('assets/images/slider/slider-bg-2.jpg')}}" alt="" class="img-slide">--}}
{{--                    <div class="slide-info slide-2">--}}
{{--                        <h2 class="f-title">Upload</h2>--}}
{{--                        <span class="f-subtitle">Your prescription</span>--}}
...
{{--                </div>--}}
{{--                <div class="item-slide">--}}
{{--                    <img src="{{asset('assets/images/slider/slider-bg-3.jpg')}}" alt="" class="img-slide">--}}
{{--                    <div class="slide-info slide-3">--}}
{{--                        <h2 class="f-title">Book <b>Your Appointment</b></h2>--}}
{{--                        <span class="f-subtitle"></span>--}}
{{--                        <p class="sale-info"><b class="price"></b></p>--}}
{{--                        <a href="#" class="btn-link">DO Now</a>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
                ...
                @foreach ($sliders as $slide)
                    <div class="item-slide">
                        ...
                        <div class="slide-info slide-1">
                            ...
                            <p class="sale-info"><span class="price">{{$slide->price}}</span></p>
        ...
        <div class="wrap-banner style-twin-default">
            <div class="banner-item">
                <a href="/PrescripUpload" class="link-banner banner-effect-1">
                    <figure><img src="{{asset('assets/images/h_banner/home-1-banner-1.png')}}" alt="" width="580" height="190"></figure>
                </a>
            </div>
            <div class="banner-item">
                <a href="#" class="link-banner banner-effect-1">
                    <figure><img src="{{asset('assets/images/h_banner/home-1-banner-2.png')}}" alt="" width="580" height="190"></figure>
                </a>
            </div>
        </div>
